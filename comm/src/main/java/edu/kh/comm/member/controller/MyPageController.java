...
public class MyPageController {
   ...
   public String updateProfile(@ModelAttribute("loginMember")Member loginMember,
		   						...
		   						RedirectAttributes ra) throws IOEeception{
	   
	   //경로 작성하기
	   //1) 웹 접근할 경로(/comm/resources/images/memberProfile/)
	   
	   String webPath = "/resources/images/memberProfile/";
	   
	   //2) 서버 저장 폴더 경로 C:\workspace\07_Framework\comm\src\main\webapp\resources\images\memberProfile
	   String folderPath = req.getSession().getServletContext().getRealPath(webPath);
	   //이렇게 쓰면 저 폴더 경로가 얻어와짐 :) 기냥 기억해 ^^
